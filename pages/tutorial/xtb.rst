...
This chapter will investigate some basic usage of the extended tight binding (xTB) methods.\ :footcite:`bannwarth2020`
...
.. tab-set::
   ...
   .. tab-item:: GFN1-xTB\ :footcite:`grimme2017-1`

      .. literalinclude:: xtb/gfn1-xtb.hsd
         :caption: dftb_in.hsd
         :language: shell
         :emphasize-lines: 6

   .. tab-item:: GFN2-xTB\ :footcite:`bannwarth2019`

      .. literalinclude:: xtb/gfn2-xtb.hsd
         :caption: dftb_in.hsd
         :language: shell
         :emphasize-lines: 6

   .. tab-item:: IPEA1-xTB\ :footcite:`asgeirsson2017`

      .. literalinclude:: xtb/ipea1-xtb.hsd
         :caption: dftb_in.hsd
         :language: shell
         :emphasize-lines: 6
...
.. literalinclude:: xtb/mindless42.xyz
   :caption: struc.xyz
...
To obtain the parameter file for the GFN1(Si)-xTB method,\ :footcite:`komissarov2021` we start by creating the GFN1-xTB parameter file from the internal parametrization storage
...
.. literalinclude:: xtb/gfn1-si-xtb.toml
...
.. literalinclude:: xtb/gfn1-si-xtb.hsd
   :caption: dftb_in.hsd
   :language: shell
   :emphasize-lines: 6
...
.. dropdown:: Difference between GFN1-xTB and GFN1(Si)-xTB parameter file
   ...
   .. literalinclude:: xtb/gfn1-si-xtb.diff
      :language: diff
