...
.. dropdown:: Convert script gradient output
   ...
   .. literalinclude:: reaction/dp2orca.awk
      :caption: \*dp2orca.awk
      :language: awk
...
.. literalinclude:: reaction/inversion/inpfileq
   :caption: inpfileq
   :language: none
...
.. tab-set::
   ...
   .. tab-item:: image
      ...
      .. image:: reaction/inversion/reactant.png
         :scale: 50%
...
.. tab-set::
   ...
   .. tab-item:: image
      ...
      .. image:: reaction/inversion/product.png
         :scale: 50%


For our first calculation we will use GFN2-xTB

.. literalinclude:: reaction/inversion/dftb_in.hsd
   :caption: dftb_in.hsd
   :language: sh
...
.. image:: reaction/inversion/ts.png
   :scale: 50%
...
.. literalinclude:: reaction/diels-alder/inpfileq
   :caption: inpfileq
   :language: none
   :emphasize-lines: 18-19
...
.. tab-set::
   ...
   .. tab-item:: image
      ...
      .. image:: reaction/diels-alder/reactant.png
         :scale: 50%
...
.. tab-set::
   ...
   .. tab-item:: image
      ...
      .. image:: reaction/diels-alder/product.png
         :scale: 50%
...
.. tab-set::
   ...
   .. tab-item:: GFN2-xTB
      ...
      .. literalinclude:: reaction/diels-alder/gfn2-xtb.hsd
         :caption: dftb_in.hsd
         :language: sh

   .. tab-item:: GFN1-xTB

      .. literalinclude:: reaction/diels-alder/gfn1-xtb.hsd
         :caption: dftb_in.hsd
         :language: sh

   .. tab-item:: DFTB3-D4

      .. literalinclude:: reaction/diels-alder/dftb-3ob.hsd
         :caption: dftb_in.hsd
         :language: sh

   .. tab-item:: DFTB2-D4

      .. literalinclude:: reaction/diels-alder/dftb-mio.hsd
         :caption: dftb_in.hsd
         :language: sh

   .. tab-item:: LC-DFTB2-D4

      .. literalinclude:: reaction/diels-alder/dftb-ob2.hsd
         :caption: dftb_in.hsd
         :language: sh
...
.. tab-set::
   ...
   .. tab-item:: coordinates
      ...
      .. literalinclude:: reaction/claisen/reactant.xyz
         :caption: reactant.xyz
         :language: none
   ...
   .. tab-item:: image
      ...
      .. image:: reaction/claisen/reactant.png
         :scale: 50%
...
.. tab-set::
   ...
   .. tab-item:: coordinates
      ...
      .. literalinclude:: reaction/claisen/product.xyz
         :caption: product.xyz
         :language: none
   ...
   .. tab-item:: image
      ...
      .. image:: reaction/claisen/product.png
         :scale: 50%
